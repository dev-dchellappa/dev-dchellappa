...
## Lets start with what we want to acheive: the Problem Domain

# I want to model employee life cycle
...
# salary must "credited" to each emp
# SalesPerson "generates" Booking
# Consultant "generates" revenue

## Now lets do the modelling
...
#Employee
    ...
    # quit() # and can quite
    # what about joining? well, when emp is created, we can implement the onboarding process in the constructor
...
# Emp ID's are maintained at Company level
# so we need to model a Company
# How do we do that?
# Option 1 - creeate a class. Hmm...bad idea. As that will allow creating multiple instances of 
...
# can be created.
# But as I a new to Python, I dont know if Singleton can be implemented
# So..for now, lets implement Company as a Module
# 
# Company Module:
